...
public interface Liste<T> extends Beholder<T>
  {
    ...
    /*ny*/public void leggInn(int indeks, T verdi);  // Nytt element på plass indeks
    public boolean inneholder(T verdi);        // Er verdi i listen?
    /*ny*/public T hent(int indeks);                 // Hent element på plass indeks
    /*ny*/public int indeksTil(T verdi);             // Hvor ligger verdi?
    /*ny*/public T oppdater(int indeks, T verdi);    // Oppdater på plass indeks
    public boolean fjern(T verdi);             // Fjern objektet verdi
    /*ny*/public T fjern(int indeks);                // Fjern elementet på plass indeks
